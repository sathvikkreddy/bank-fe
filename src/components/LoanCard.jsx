...
const LoanCard = ({
  ...
  return (
    <div className="w-full p-2">
      <Link to={route}>
        <div className="w-full border rounded-lg p-5 hover:shadow-xl hover:transition-all hover:border relative group">
          ...
          <img
            src={image}
            alt={type}
            className="w-full h-48 md:h-56 lg:h-64 object-cover rounded-lg mb-4 group-hover:shadow-md"
          />
          ...
          <div className="flex justify-center font-semibold absolute bottom-0 left-0 right-0 bg-blue-200 text-center py-2 rounded-b-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300">
